...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/13 12:37:48 by lcordeno          #+#    #+#             */
/*   Updated: 2019/02/23 17:54:12 by lcordeno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	*thr_julia(void *env)
{
	t_env		*tmp;
...
void		set_thr_julia(t_env *env)
{
	...
	while (i < 10)
	{
		...
		if (pthread_create(&threads[i], NULL, thr_julia, &tab[i]))
		{
