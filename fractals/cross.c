...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/23 15:31:15 by lcordeno          #+#    #+#             */
/*   Updated: 2019/02/23 17:51:15 by lcordeno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/fractol.h"

void		ft_cross(t_env *env)
{
...
static void	*thr_cross(void *env)
{
	t_env		*tmp;
...
void		set_thr_cross(t_env *env)
{
	...
	while (i < 10)
	{
		...
		if (pthread_create(&threads[i], NULL, thr_cross, &tab[i]))
		{
